...
c&&(c+=1);1<c&&--c;return c<1/6?a+6*(b-a)*c:.5>c?b:c<2/3?a+(b-a)*(2/3-c)*6:a}var d=/hsl\((\d+),\s*([\d.]+)%,\s*([\d.]+)%\)/g.exec(a);a=parseInt(d[1])/360;var c=parseInt(d[2])/100,d=parseInt(d[3])/100;if(0==c)c=d=a=d;else{var g=.5>d?d*(1+c):d+c-d*c,k=2*d-g,c=b(k,g,a+1/3),d=b(k,g,a);a=b(k,g,a-1/3)}return"rgb("+255*c+","+255*d+","+255*a+")"}function V(a){if(e.rgba(a))return/rgba\((\d+),\s*(\d+),\s*(\d+),\s*(\d+)\)/g.exec(a),"rgb("+rgb[1]+","+rgb[2]+","+rgb[3]+")";if(e.rgb(a))return a;if(e.hex(a))return T(a);
...
0:a.tween.from.numbers[c];b=c+a.eased*(b-c);a.isPath$1&&(b=ca(a.tween.value,b));a.round&&(b=Math.round(b*a.round)/a.round);return b}}(e)),e.tween.to.strings);if("filter"===h.type)R[h.type](n.target,h.property,k,d,n.id);else R[h.type](n.target,h.property,k,c,n.id);h.currentValue=k;b++;e={isPath$1:e.isPath$1,tween:e.tween,eased:e.eased,round:e.round}}if(c)for(var l in c)F||(F=D(document.body,"transform")?"transform":"-webkit-transform"),f.animatables[l].target.style[F]=c[l].join(" ");if(d)for(var t in d)f.animatables[t].target.style.filter=
d[t].join(" ");f.currentTime=a;f.progress=a/f.duration*100}function g(a){if(f[a])f[a](f)}function e(){f.remaining&&!0!==f.remaining&&f.remaining--}function h(a){var h=f.duration,k=f.offset,m=f.delay,P=f.currentTime,q=f.reversed,r=d(a),r=Math.min(Math.max(r,0),h);if(f.children){var p=f.children;if(r>=f.currentTime)for(var u=0;u<p.length;u++)p[u].seek(r);else for(u=p.length;u--;)p[u].seek(r)}r>k&&r<h?(c(r),!f.began&&r>=m&&(f.began=!0,g("begin")),g("run")):(r<=k&&0!==P&&(c(0),q&&e()),r>=h&&P!==h&&(c(h),
q||e()));a>=h&&(f.remaining?(t=n,"alternate"===f.direction&&(f.reversed=!f.reversed)):(f.pause(),"Promise"in window&&(Q(),S=b()),f.completed||(f.completed=!0,g("complete"))),l=0);g("update")}a=void 0===a?{}:a;var n,t,l=0,Q=null,S=b(),f=ka(a);f.reset=function(){var a=f.direction,b=f.loop;f.currentTime=0;f.progress=0;f.paused=!0;f.began=!1;f.completed=!1;f.reversed="reverse"===a;f.remaining="alternate"===a&&1===b?2:b;for(a=f.children.length;a--;)b=f.children[a],b.seek(b.offset),b.reset()};f.tick=function(a){n=
a;t||(t=n);h((l+n-t)*m.speed)};f.seek=function(a){h(d(a))};f.pause=function(){var a=q.indexOf(f);-1<a&&q.splice(a,1);f.paused=!0};f.play=function(){f.paused&&(f.paused=!1,t=0,l=d(f.currentTime),q.push(f),z||na())};f.reverse=function(){f.reversed=!f.reversed;t=0;l=d(f.currentTime)};f.restart=function(){f.pause();f.reset();f.play()};f.finished=S;f.reset();f.autoplay&&f.play();return f}var la={update:void 0,begin:void 0,run:void 0,complete:void 0,loop:1,direction:"normal",autoplay:!0,offset:0},ma={duration:1E3,
delay:0,easing:"easeOutElastic",elasticity:500,round:0},Z="translateX translateY translateZ rotate rotateX rotateY rotateZ scale scaleX scaleY scaleZ skewX skewY".split(" "),F,Y="grayscale sepia saturate hue-rotate invert opacity brightness contrast blur".split(" "),e={arr:function(a){return Array.isArray(a)},obj:function(a){return-1<Object.prototype.toString.call(a).indexOf("Object")},svg:function(a){return a instanceof SVGElement},dom:function(a){return a.nodeType||e.svg(a)},str:function(a){return"string"===
typeof a},fnc:function(a){return"function"===typeof a},und:function(a){return"undefined"===typeof a},hex:function(a){return/(^#[0-9A-F]{6}$)|(^#[0-9A-F]{3}$)/i.test(a)},rgba:function(a){return/^rgba/.test(a)},rgb:function(a){return/^rgb/.test(a)},hsl:function(a){return/^hsl/.test(a)},col:function(a){return e.hex(a)||e.rgba(a)||e.rgb(a)||e.hsl(a)}},y=function(){function a(a,d,c){return(((1-3*c+3*d)*a+(3*c-6*d))*a+3*d)*a}return function(b,d,c,g){if(0<=b&&1>=b&&0<=c&&1>=c){var e=new Float32Array(11);
if(b!==d||c!==g)for(var h=0;11>h;++h)e[h]=a(.1*h,b,c);return function(h){if(b===d&&c===g)return h;if(0===h)return 0;if(1===h)return 1;for(var k=0,l=1;10!==l&&e[l]<=h;++l)k+=.1;--l;var l=k+(h-e[l])/(e[l+1]-e[l])*.1,n=3*(1-3*c+3*b)*l*l+2*(3*c-6*b)*l+3*b;if(.001<=n){for(k=0;4>k;++k){n=3*(1-3*c+3*b)*l*l+2*(3*c-6*b)*l+3*b;if(0===n)break;var m=a(l,b,c)-h,l=l-m/n}h=l}else if(0===n)h=l;else{var l=k,k=k+.1,f=0;do m=l+(k-l)/2,n=a(m,b,c)-h,0<n?k=m:l=m;while(1e-7<Math.abs(n)&&10>++f);h=m}return a(h,d,g)}}}}(),
...
function(b,c){return 1-a(1-b,c)}],InOut:[[.455,.03,.515,.955],[.645,.045,.355,1],[.77,0,.175,1],[.86,0,.07,1],[.445,.05,.55,.95],[1,0,0,1],[.785,.135,.15,.86],[.68,-.55,.265,1.55],function(b,c){return.5>b?a(2*b,c)/2:1-a(-2*b+2,c)/2}]},c={linear:y(.25,.25,.75,.75)},g={},k;for(k in d)g.type=k,d[g.type].forEach(function(a){return function(d,g){c["ease"+a.type+b[g]]=e.fnc(d)?d:y.apply($jscomp$this,d)}}(g)),g={type:g.type};return c}(),R={css:function(a,b,d){return a.style[b]=d},attribute:function(a,b,
d){return a.setAttribute(b,d)},object:function(a,b,d){return a[b]=d},transform:function(a,b,d,c,g){c[g]||(c[g]=[]);c[g].push(b+"("+d+")")},filter:function(a,b,d,c,g){c[g]||(c[g]=[]);c[g].push(b+"("+d+")")}},q=[],z=0,na=function(){function a(){z=requestAnimationFrame(b)}function b(b){var c=q.length;if(c){for(var d=0;d<c;)q[d]&&q[d].tick(b),d++;a()}else cancelAnimationFrame(z),z=0}return a}();m.version="2.0.2";m.speed=1;m.running=q;m.remove=function(a){a=M(a);for(var b=q.length;b--;)for(var d=q[b],
c=d.animations,g=c.length;g--;)A(a,c[g].animatable.target)&&(c.splice(g,1),c.length||d.pause())};m.getValue=J;m.path=function(a,b){var d=e.str(a)?v(a)[0]:a,c=b||100;return function(a){return{el:d,property:a,totalLength:d.getTotalLength()*(c/100)}}};m.setDashoffset=function(a){var b=a.getTotalLength();a.setAttribute("stroke-dasharray",b);return b};m.bezier=y;m.easings=N;m.timeline=function(a){var b=m(a);b.pause();b.duration=0;b.add=function(a){b.children.forEach(function(a){a.began=!0;a.completed=
!0});w(a).forEach(function(a){var c=b.duration,d=a.offset;a.autoplay=!1;a.offset=e.und(d)?c:K(d,c);b.seek(a.offset);a=m(a);a.duration>c&&(b.duration=a.duration);a.began=!0;b.children.push(a)});b.reset();b.seek(0);b.autoplay&&b.restart();return b};return b};m.random=function(a,b){return Math.floor(Math.random()*(b-a+1))+a};return m});